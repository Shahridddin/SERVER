...
public class SavedController {
    ...
    public SavedController(FavoriteService favoriteService, BookRepository bookRepository, AuthUserRepository authUserRepository, FavoriteRepository favoriteRepository, Session session) {
