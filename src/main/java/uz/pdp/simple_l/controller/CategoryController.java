...
public class CategoryController {
    ...
    public String createCategory(@ModelAttribute CategoryCreateDto dto,
        ...
        boolean succesCategory = categoryRepository.existsByName(dto.name());
        if (succesCategory) {
    ...
    public String createChildCategory(@ModelAttribute ChildCategoryCreateDto dto, HttpSession session) {
