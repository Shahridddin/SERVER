...
public class RegisterController {
    ...
    public RegisterController(AuthUserCreateService authUserCreateService, CustomAuthenticationSuccessHandler successHandler) {
    ...
    public String create(@ModelAttribute AuthUserCreateDto dto,
        ...
        return "redirect:" + successHandler.toString();
    }
}
